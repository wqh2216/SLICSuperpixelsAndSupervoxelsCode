...
SLICSuperpixels.h
	...
	这是应用程序的主要头文件。它包括其他项目特定的头文件（resource.h），是cslicsuperpixelsapp应用类。

SLICSuperpixels.cpp
    This is the main application source file that contains the application
    class CSLICSuperpixelsApp.
	这是包含应用程序类cslicsuperpixelsapp主应用程序源文件。
...
SLICSuperpixelsDlg.h, SLICSuperpixelsDlg.cpp - the dialog
	...
	slicsuperpixelsdlg。H，slicsuperpixelsdlg.cpp -对话这些文件包含你的cslicsuperpixelsdlg类。
	这个类定义应用程序主对话框的行为。对话框的模板是在SLICSuperpixels.rc，可以在微软Visual C++编辑。
